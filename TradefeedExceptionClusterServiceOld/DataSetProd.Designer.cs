...
namespace TradefeedExceptionClusterService {
    ...
    public partial class DataSetProd : global::System.Data.DataSet {
        ...
        public partial class ClusterDataTable : global::System.Data.TypedTableBase<ClusterRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClusterRow AddClusterRow(decimal TraderCMID, decimal BrokerCMID, decimal CommodityID, System.DateTime EffectiveStartDate, string ApprovalStatus, string CreatedBy, System.DateTime CreatedDate, string LastUpdatedBy, System.DateTime LastUpdatedDate, System.DateTime EffectiveEndDate, string ApprovalDesc, decimal OriginalID, string ActionFlag) {
...
SELECT TradeFeedID, BusinessDate, ExchangeID, ApprovalStatus, Message, ApprovalDesc, CreatedBy, CreatedDate, LastUpdatedBy, LastUpdatedDate, ForceApproveOperationsType FROM TradefeedException WHERE (ApprovalStatus = @ApprovalStatus) AND (BusinessDate = @BusinessDate) AND (ExchangeID = @ExchangeID) AND (TradeFeedID = @TradeFeedID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ApprovalDesc, ApprovalStatus, BusinessDate, CreatedBy, CreatedDate, Exchan" +
                ...
                "FeedID FROM TradefeedException WHERE (BusinessDate = @date) AND (Message LIKE \'%" +
                "cluster%\')";
...
SELECT TraderCMID, BrokerCMID, CommodityID, EffectiveStartDate, ApprovalStatus, ClusterID, CreatedBy, CreatedDate, LastUpdatedBy, LastUpdatedDate, EffectiveEndDate, ApprovalDesc, OriginalID, ActionFlag FROM Cluster WHERE (ApprovalStatus = @ApprovalStatus) AND (BrokerCMID = @BrokerCMID) AND (CommodityID = @CommodityID) AND (EffectiveStartDate = @EffectiveStartDate) AND (TraderCMID = @TraderCMID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT ActionFlag, ApprovalDesc, ApprovalStatus, BrokerCMID, ClusterID, CommodityID, CreatedBy, CreatedDate, EffectiveEndDate, EffectiveStartDate, LastUpdatedBy, LastUpdatedDate, OriginalID, TraderCMID FROM Cluster WHERE (BrokerCMID = @brokerCMID) AND (TraderCMID = @traderCMID) AND (EffectiveStartDate = @date)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
