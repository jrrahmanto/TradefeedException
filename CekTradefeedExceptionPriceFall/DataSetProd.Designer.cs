...
namespace CekTradefeedExceptionPriceFall.DataSetProdTableAdapters {
...
SELECT TradeFeedID, BusinessDate, ExchangeID, ApprovalStatus, Message, ApprovalDesc, CreatedBy, CreatedDate, LastUpdatedBy, LastUpdatedDate, ForceApproveOperationsType FROM TradefeedException WHERE (ApprovalStatus = @ApprovalStatus) AND (BusinessDate = @BusinessDate) AND (ExchangeID = @ExchangeID) AND (TradeFeedID = @TradeFeedID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CekTradefeedExceptionPriceFall.Properties.Settings.Default.SKDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT * FROM SKD.TradefeedException WHERE BusinessDate = @date AND Message LIKE " +
                "\'%threshold%\'";
