...
namespace TradefeedExceptionsCluster.DataSetDevTableAdapters {
...
SELECT TraderCMID, BrokerCMID, CommodityID, EffectiveStartDate, ApprovalStatus, ClusterID, CreatedBy, CreatedDate, LastUpdatedBy, LastUpdatedDate, EffectiveEndDate, ApprovalDesc, OriginalID, ActionFlag FROM Cluster WHERE (ApprovalStatus = @ApprovalStatus) AND (BrokerCMID = @BrokerCMID) AND (CommodityID = @CommodityID) AND (EffectiveStartDate = @EffectiveStartDate) AND (TraderCMID = @TraderCMID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TradefeedExceptionsCluster.Properties.Settings.Default.SKDTESTINGConnectionString;
        }
        ...
        public virtual int Fill(DataSetDev.ClusterDataTable dataTable) {
        ...
        public virtual DataSetDev.ClusterDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetDev.ClusterDataTable dataTable = new DataSetDev.ClusterDataTable();
        ...
        public virtual int FillByFilter(DataSetDev.ClusterDataTable dataTable, decimal brokerCMID, decimal traderCMID, System.DateTime date) {
        ...
        public virtual DataSetDev.ClusterDataTable GetDataByFilter(decimal brokerCMID, decimal traderCMID, System.DateTime date) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(brokerCMID));
            this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(traderCMID));
            this.Adapter.SelectCommand.Parameters[2].Value = ((System.DateTime)(date));
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetDev.ClusterDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetDev dataSet) {
